...
\begin{refImpl}
\studio \,filter \filter{SelectThresholdValue}{ImageThresholding} implements the following threshold selection methods: HistogramIntermodes, ClusteringKMeans, ClusteringOtsu, Entropy. 
\end{refImpl}
