...
\paragraph*{}
\reffig{SegmentationStraightAndArciform} demonstrated an example application of Ramer segmentation with post-processing with the amendments described above.
