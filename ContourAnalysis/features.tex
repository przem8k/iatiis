...
\filter{ShapePrincipalAxes}{ShapeFeatures}. 
\end{refImpl}
...
\filter{PathLength}{PathFeatures} and
\filter{RegionConvexHull}{PathFeatures}.

\paragraph*{}
The following \studio filters extract the features defined only for polygons: 
\filter{ShapeContours}{ShapeFeatures}, 
\filter{ShapeConvexity}{ShapeFeatures}, 
\filter{ShapeCompactness}{ShapeFeatures}, 
\filter{ShapeDiameter}{ShapeFeatures} and 
