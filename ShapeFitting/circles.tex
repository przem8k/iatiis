...
\begin{refImpl}
\studio filter \filter{FitCircleToPoints}{GeometryFeatures} implements a selection of algebraic line fitting methods along with optional iterative outlier suppression, while the \filter{FitArcToPoints}{GeometryFeatures} performs analogous fitting of circular arcs.
\end{refImpl}